...
def build(id, source_code, input_data = None):
    ...
    source_file, input_file, output_file, err_file = extension("javascript")
    ...
    ret_val =  subprocess.call(["node", source_file], stdin = fin, stdout = fout, stderr = ferr)
    ...
    # if delete(source_file, input_file , output_file, err_file) == -1:
    #    return {"id": id, "error": "Error occured while deleting files"}, 403
    # Return result
    return ret_obj, 200
