...
type EditorContainerProps = {
  onDark: (isDarkMode: boolean) => void,
...
export class EditorContainer extends Component<EditorContainerProps, EditorContainerState> {
  code: Array<{ lang: string, code?: string }>;
  ...
  render() {
    ...
    return (
      <Grid>
        ...
        <Grid.Row centered>
          <Grid.Column width={16} stretched className={Styles['editor-col']}>
            <MonacoEditor
            ...
            <Grid.Column stretched>
              <Form>
                <TextArea
                  ...
                  className={Styles[classNames({ 'dark': theme === 'vs-dark' })]}
                />
              </Form>
            </Grid.Column>
          </Grid.Row>
